...
CREATE TABLE tbl_usuario (
  ...
  usua_cor varchar(50) NOT NULL UNIQUE, -- Numero de cedula del usuario
  usua_pas text NOT NULL, -- Numero de cedula del usuario
  usua_fot text NOT NULL, -- Numero de cedula del usuario
  usua_dir varchar(50) NOT NULL,  -- Numero de cedula del usuario
  usua_rol varchar(20) NOT NULL,  -- Numero de cedula del usuario
  usua_est varchar(15) NOT NULL,  -- Numero de cedula del usuario
  usua_empr_fk varchar(15) NOT NULL,  -- Numero de cedula del usuario
...
CREATE TABLE tbl_comprobante(
  ...
  comp_tipo_fk int(5) NOT NULL, -- Tipo de comprobante
	comp_clpr_fk int(10) NOT NULL, -- Llave foranea del cliente o proveedor
