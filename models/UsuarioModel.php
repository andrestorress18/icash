...
class UsuarioModel extends Model{
    ...
    public function set($usuario_data = array()) {
        ...
        $this->query = "UPDATE tbl_usuario SET usua_ced = '$usua_ced', usua_nom = '$usua_nom', usua_cor = '$usua_cor', usua_rol = '$usua_rol', usua_est = '$usua_est', usua_enti_fk = $usua_enti_fk";
    ...
    public function add($usuario_data = array()) {
        ...
        $this->query = "INSERT INTO tbl_usuario (usua_ced,usua_nom,usua_cor,usua_pas,usua_img,usua_rol,usua_est,usua_enti_fk) VALUES ('$usua_ced','$usua_nom','$usua_cor',MD5('$usua_pas'),'$usua_img','$usua_rol','$usua_est',$usua_enti_fk)";
         return $this->set_query();
    }
